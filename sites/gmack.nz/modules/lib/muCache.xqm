...
@version 0.01
:)
module namespace muCache="http://markup.nz/#muCache";
...
import  module namespace muSan = "http://markup.nz/#muSan" at 'muSan.xqm';
import  module namespace muUtility = "http://markup.nz/#muUtility" at 'muUtility.xqm';
...
(:~
given URL fetch from cache xhtml doc stored from a http-client request
