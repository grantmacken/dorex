...
module namespace router = "http://zie.nz/#router";
...
import module namespace archive="http://zie.nz/#archive" at "../lib/archive.xqm";
import module namespace note="http://zie.nz/#note" at "../lib/note.xqm";
import module namespace site="http://zie.nz/#site" at "../render/site.xqm";
import module namespace feed="http://zie.nz/#feed" at "../render/feed.xqm";
import module namespace entry="http://zie.nz/#entry" at "../render/entry.xqm";
import module namespace muURL="http://zie.nz/#muURL" at "../lib/muURL.xqm";
import module namespace muUtility="http://zie.nz/#muUtility" at "../lib/muUtility.xqm";
:)
(:############################################################################:)
...
'notFound' := QName( 'http://zie.nz/#router','documentNotAvailable'),
'wmError'  : QName( 'http://zie.nz/#router','webmentionError')
};
...
declare
    %rest:GET
    %rest:path( "/zie.nz/pages/home.html")
 ...
 return
  ...
  <rest:response>
    <http:response status="200" message="OK">
     <http:header name="Link" value="&lt;https://zie.nz/webmention&gt; rel='webmention'"/>
    </http:response>
  </rest:response>,
  <div>
    <h1> TODO! </h1>
...
declare
    %rest:GET
    %rest:path("/zie.nz/resources/styles/{$css}")
...
declare
    %rest:GET
    %rest:path("/zie.nz/resources/scripts/{$script}")
...
declare
    %rest:GET
    %rest:path("/zie.nz/resources/icons/{$icons}")
    %output:method("xml")
